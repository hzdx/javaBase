...
/**
 * 代理 动态生成Proxy类，继承了源接口和Object的方法
 * 
 * @author ldm
 *
 */
public class proxyTest {
	...
	public static void main(String[] args) throws NoSuchMethodException,
		...
		Class clazz = Proxy.getProxyClass(List.class.getClassLoader(),
				List.class);
		...
		List proxy3 = (List) Proxy.newProxyInstance(
	...
	private static String getCons(Class clazz) {
		...
		for (Constructor con : cons) {
			...
			if (pramClasses != null && pramClasses.length != 0)
