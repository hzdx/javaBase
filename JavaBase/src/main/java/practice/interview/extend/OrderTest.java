 ...
 * 构造函数、子类A静态代码块、子类A非静态代码块，执行的先后顺序是? 结果： 这是父类的静态代码块！ 这是子类的静态代码块！ 这是父类的非静态代码块！
 * 这是父类 的构造方法！ 这是子类的非静态代码块！ 这是子类的构造方法！ 父类的静态代码块->子类的静态代码块->父类的非静态代码块->父类 的构造方法
 * ->子类的非静态代码块 ->子类的构造方法 静态代码最先，在类字节码加载时已有。
 *
