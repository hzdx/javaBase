...
/**
 * 类加载器 AppClassLoader 默认加载classPath下的类 ExtClassLoader 默认加载 jre/lib/ext/下的类
 * BootStrap? 最高级加载器，java无法获取 还可以自定义类加载器，加载指定的类，
...
public class LoaderTest {
	...
	public static void main(String[] args) throws IOException {
		...
		InputStream is = LoaderTest.class.getClassLoader().getResourceAsStream("reflect/config.properties");
